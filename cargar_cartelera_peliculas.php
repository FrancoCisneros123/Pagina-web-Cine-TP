...
$sql = $conn->query("SELECT id_pelicula, nombre_pelicula, nombre_imagen FROM pelicula WHERE esEstreno='no'");
    ...
    echo "
            <div class='col-12 col-xs-12 col-md-6 col-lg-6 col-xl-4'>
                ...
                <div class='card card-individual-estreno'>
                    <img src='" . $datos["nombre_imagen"] . "' class='card-img-top imagen-cards'>
