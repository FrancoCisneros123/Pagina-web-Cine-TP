...
if (!$permisosObj->tienePermiso("editar notificacion", $_SESSION["id_usuario"])) {
...
<head>
    ...
    <title>CineEnCartelera - Actualizar notificacion</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="mt-3">Actualizar notificacion:</h2><br>
