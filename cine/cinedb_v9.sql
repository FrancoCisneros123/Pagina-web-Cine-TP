...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2023 a las 03:47:06
...
INSERT INTO `sala` (`id_sala`, `id_complejo`, `id_sala_asiento`) VALUES
(1, 1, 0),
(2, 1, 0),
(3, 1, 0),
(4, 2, 0),
...
--
-- Estructura de tabla para la tabla `sala_asiento_reservado`
--

CREATE TABLE `sala_asiento_reservado` (
  `id_sala` int(11) NOT NULL,
  `asiento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `sala_asiento_reservado`
--

INSERT INTO `sala_asiento_reservado` (`id_sala`, `asiento`) VALUES
(6, 3),
(6, 5);
...
(1, 'clienteTest@gmail.com', 'clienteTest', 'cliente', 'test', '123456789', '2015-10-14', 'Masculino', 1),
...
--
-- Indices de la tabla `sala_asiento_reservado`
--
ALTER TABLE `sala_asiento_reservado`
  ADD KEY ` foreing_key` (`id_sala`);
...
--
-- Filtros para la tabla `sala_asiento_reservado`
--
ALTER TABLE `sala_asiento_reservado`
  ADD CONSTRAINT ` foreing_key` FOREIGN KEY (`id_sala`) REFERENCES `sala` (`id_sala`);
