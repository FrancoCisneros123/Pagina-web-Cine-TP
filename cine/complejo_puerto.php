...
<head>
    ...
    <title>CineEnCartelera - Complejo Puerto madero</title>
...
<body>
    <div class="container-fluid" style="padding: 0%;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <h4>Complejo Puerto Madero, Buenos Aires</h4>
                    <b>Dirección: </b>
                    <p>Formosa 653 Puerto Madero, (Shopping Puerto)</p>
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="imagenes/establecimiento_cine_complejos2.jpeg" class="d-block w-100"
                                    alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img src="imagenes/sala_complejos4.jpeg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="imagenes/snaks_complejos2.jpeg" class="d-block w-100" alt="...">
                            </div>
                        </div>
                    ...
                    <p style="margin-top: 20px;">Este complejo está ubicado en Puerto Madero, Buenos Aires</p>
                    ...
                    <p style="margin-bottom: 60px;">En septiembre de 2019 Cine en cartelera Puerto Madero instaló en su
                ...
                <iframe style="margin-bottom: 30px;"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52538.06130269082!2d-58.39346883021903!3d-34.6135460840105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a334d9c2d70389%3A0xe7b5e9ee316678f!2sPuerto%20Madero%2C%20CABA!5e0!3m2!1ses-419!2sar!4v1697830127469!5m2!1ses-419!2sar"
