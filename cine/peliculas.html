...
<head>
    ...
    <link rel="stylesheet" href="css/estilo_descripcion.css">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div id="MenuNavegacion" class="collapse navbar-collapse">
                    <ul class="navbar-nav ms-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">COMPLEJOS</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        ...
        <img src="imagenes/theflashcarrusel.png" alt="" class="imagen-descripcion">

        <h2>Ficha tecnica</h2>

        <p>Año 2023 Duración 144 min. </p>
        <p>Género
            Ciencia ficción. Acción. Fantástico. Comedia | Superhéroes. Cómic. DC Comics. Viajes en el tiempo</p>
        ...
        <p class="parrafo-descripcion">
            ...
            Los mundos chocan en "Flash" cuando Barry utiliza sus superpoderes para viajar en
            el tiempo y cambiar los acontecimientos del pasado. Barry intenta salvar a su familia,
            pero sin saberlo altera el futuro y queda atrapado en una realidad en la que el general
            Zod ha regresado y amenaza con la aniquilación, pero en la que no hay Superhéroes a los
            que recurrir. A menos que Barry pueda persuadir a un Batman muy diferente para que salga
            de su retiro y rescate a un kryptoniano encarcelado... aunque no sea el que está buscando.
            En última instancia, para salvar el mundo en el que se encuentra y regresar al futuro que
            conoce, la única esperanza de Barry es luchar por seguir vivo. Pero ¿este último sacrificio
            será suficiente para reiniciar el universo? (FILMAFFINITY)
        </p>
        <button class="btn btn-primary" type="button" id="disponibilidad">Ver disponibilidad de la sala</button>
        ...
        <div class="container-fluid">
            <div class="row p-5 pb-2 bg-dark text-white">
                ...
                <div class="col-xs-12 col-md-6 col-lg-3">
                    ...
                    <div class="mb-2">
                        <a class="text-secondary text-decoration-none" href="">Cartelera</a>
                    </div>
                ...
                <div class="col-xs-12 col-md-6 col-lg-3">
                    ...
                    <div class="mb-2">
                        <a class="text-secondary text-decoration-none" href="">Canning</a>
                    </div>
    
                    <div class="mb-2">
                        <a class="text-secondary text-decoration-none" href="">Madero</a>
                    </div>
                ...
                <div class="col-xs-12 pt-4"> <!--pt = padding top 4-->
